...
interface ResearchOutputNodeProps {
  data: {
    id: string;
    description: string;
...
const ResearchOutputNode: FC<ResearchOutputNodeProps> = ({ data }) => {
      ...
      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full">
        <Card className="w-[300px] backdrop-blur-md bg-card/10 backdrop-opacity-100 shadow-lg hover:shadow-xl rounded-3xl h-fit">
          ...
          <CardHeader
            ...
            aria-controls="research-output-content"
          >
            <CardTitle className="flex items-center justify-between">
              <div className="flex items-center">
                <FileOutput strokeWidth={1.5} className="ml-1 mr-2 h-4 w-4 flex-shrink-0" />
          ...
          >
            <CardContent id="research-output-content" className="py-4 px-4">
...
export default ResearchOutputNode;
