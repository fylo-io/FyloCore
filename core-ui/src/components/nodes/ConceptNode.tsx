...
const getIcon = (type: TabType) => {
  switch (type) {
    ...
    case "methods":
      return <LightbulbIcon strokeWidth="1.5" className="mr-2 h-3 w-3 text-primary" />;
    default:
      return null;
  }
};

const ConceptNode: FC<ConceptNodeProps> = ({ data }) => {
        ...
        <Card className="w-[300px] backdrop-blur-md bg-card/10 backdrop-opacity-100 shadow-lg hover:shadow-xl rounded-3xl h-fit">
          ...
          >
            <CardTitle className="flex items-center justify-between">
              <div className="flex items-center">
                <LightbulbIcon strokeWidth={1.5} className="ml-1 mr-2 h-4 w-4 flex-shrink-0" />
          ...
          <AnimatePresence>
            {isExpanded && (
              ...
              >
                <CardContent id="concept-content" className="py-4 px-4">
